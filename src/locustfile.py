...
class GraphWordUser(HttpUser):
    ...
    def test_nodos_aislados(self):
        ...
        response = self.client.get("/nodos_aislados", params={"type": "3"})
    ...
    def test_nodos_alto_grado(self):
        ...
        response = self.client.get("/nodos_alto_grado", params={"umbral": 2, "type": "3"})
    ...
    def test_nodos_grado_especifico(self):
        ...
        response = self.client.get("/nodos_grado_especifico", params={"grado": 3, "type": "3"})
    ...
    def test_detectar_clusters(self):
        ...
        response = self.client.get("/detectar_clusters", params={"type": "5"})
